...
export interface ConfrontationProgress {
  ...
  /** Bonus evidence IDs presented during confrontation */
  bonusEvidencePresented?: string[];
}
...
export interface AccusationConfig {
  ...
  config: {
    ...
    /** Rejection dialog shown when 3 mistakes reached during confrontation */
    rejectionDialog?: {
      speaker: string;
      text: string;
    };
...
export interface ConfrontationStatement {
  ...
  /** Optional bonus clue ID for extra insight */
  bonusEvidence?: string;
  
  /** Special response when bonus evidence is presented */
...
export interface EvidenceResult {
  ...
  /** Whether this was bonus evidence (optional) */
  isBonus?: boolean;
}
