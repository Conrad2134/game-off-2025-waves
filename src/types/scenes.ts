 ...
 * 
 * NOTE: Scene size adjusted to 1200x800 (half the original spec)
 */
...
// ============================================================================
// CONSTANTS (ADJUSTED FOR HALF SIZE: 1200x800)
// ============================================================================
...
export const LIBRARY_SCENE_CONSTANTS = {
  ...
  /** World dimensions (HALF SIZE) */
  WORLD_WIDTH: 1200,
  WORLD_HEIGHT: 800,
  
  /** Default player spawn (center of room) */
  DEFAULT_SPAWN: { x: 600, y: 400 },
